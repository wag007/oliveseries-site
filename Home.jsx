function Home({ onAbout }) {
  ...
  return (
    <div style={{ width: "100%", maxWidth: 1280, minHeight: 4457, margin: "0 auto", background: "var(--surface-page)", display: "flex", flexDirection: "column", alignItems: "center", padding: "22px 10px 20px", boxSizing: "border-box" }}>
      <NavBar items={[{ label: "About", onClick: (e) => { e.preventDefault(); onAbout(); } }, { label: "Directions", href: "#directions" }, { label: "ES", href: "/es/" }]} />
      ...
      <main style={{ display: "flex", flexDirection: "column", alignItems: "center", alignSelf: "stretch" }}>
        ...
        <TileGrid id="directions" style={{ paddingBottom: 112 }}>
          <PhotoTile className="tile" src="/assets/photo-crowd.jpg" alt="A full bar listening to a talk" />
          <ObjectTile className="tile" src="/assets/cutout-01.png" color="var(--olive-ink)" title="Poster" meta="September 26'" />
          <LinkTile className="tile" href="https://maps.google.com">Google Maps Link</LinkTile>
          <ObjectTile className="tile" src="/assets/cutout-02.png" color="var(--olive-navy)" fit="cover" title="Program" meta="October 26'" />
          <ColorTile className="tile" color="var(--olive-fog)">Talks</ColorTile>
          <PhotoTile className="tile" src="/assets/photo-tile-06.png" alt="Bar interior" />
          <ColorTile className="tile" color="var(--olive-cream)">Science</ColorTile>
          <ObjectTile className="tile" src="/assets/cutout-03.png" color="var(--olive-oxblood)" title="Cassette" meta="November 26'" />
          <ColorTile className="tile" color="var(--olive-sage)">Philosophy</ColorTile>
          <LinkTile className="tile" src="/assets/photo-tile-10.jpg">Follow Us on Substack</LinkTile>
          <ColorTile className="tile" color="var(--olive-clay)">History</ColorTile>
          <LinkTile className="tile" href="https://instagram.com">Browse the Instagram</LinkTile>
          <ColorTile className="tile" color="var(--olive-cream)">Art</ColorTile>
          <ObjectTile className="tile" src="/assets/photo-cosmos.jpg" fit="cover" color="var(--olive-blush)" textColor="var(--olive-black)" title="Tickets" meta="December 26'" />
        </TileGrid>
